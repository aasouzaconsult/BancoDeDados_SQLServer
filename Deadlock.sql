-- Autor: Alex Souza (blog: https://pessoalex.wordpress.com/)
...
insert into TbDeadCliente values ('Alex Souza', 'Rua do Falcão, 76 – Majordisneylandia – Fortaleza')
insert into TbDeadCliente values ('Antonio Souza', 'Rua do Adamastor, 24 – Testejana – Fortaleza')
insert into TbDeadCliente values ('Adamastor', 'Rua do Computador, 48 – Testelandia – Fortaleza')
insert into TbDeadCliente values ('Barnabé', 'Rua da Rosicléa')
insert into TbDeadCliente values ('Rosicléa', 'Rua do Barnabé')
